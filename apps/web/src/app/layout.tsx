...
export const metadata: Metadata = {
  ...
  description: 'Israel\'s top escort directory. Browse 150+ verified profiles with real photos, reviews & ratings. Tel Aviv, Haifa, Jerusalem. Safe, discreet, updated daily.',
  ...
  openGraph: {
    ...
    description: '150+ verified profiles with real photos, reviews & ratings. Tel Aviv, Haifa, Jerusalem.',
    images: [{
  ...
  twitter: {
    ...
    title: 'Tahles — Premium Escort Directory Israel',
    description: '150+ verified profiles. Real photos, reviews & ratings.',
