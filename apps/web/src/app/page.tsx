  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <main className="max-w-[1100px] mx-auto px-4 sm:px-6 pb-20">
        ...
        {/* ── Publish CTA ──────────────────────────────────────────────── */}
        <a
          href="https://t.me/Tahlesbot?start=publish"
          target="_blank"
        ...
        <section className="mb-2">
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
            <button
              onClick={() => handleOrigin('european')}
              className={`shrink-0 flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-sm font-bold transition-all duration-150 touch-manipulation whitespace-nowrap
                ${activeOrigin === 'european' ? 'bg-velvet-500/25 border-velvet-500/50 border text-velvet-300' : 'bg-white/[0.04] border border-white/[0.07] text-white/50 hover:text-white hover:bg-white/[0.08]'}`}
            >
              🇪🇺 {t('origin_european')}
            </button>
            <button
            ...
            <button
              onClick={() => handleOrigin('asian')}
              className={`shrink-0 flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-sm font-bold transition-all duration-150 touch-manipulation whitespace-nowrap
                ${activeOrigin === 'asian' ? 'bg-velvet-500/25 border-velvet-500/50 border text-velvet-300' : 'bg-white/[0.04] border border-white/[0.07] text-white/50 hover:text-white hover:bg-white/[0.08]'}`}
            >
              🌸 {t('origin_asian')}
            </button>
          </div>
